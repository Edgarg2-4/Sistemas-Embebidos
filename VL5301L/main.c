...
void writevl5301(int registro, int valor){
    ...
    I2C0_MDR_R=registro &0x0FF; //Envio la Subdirección( dirección del registro interno "segundos") al DS1307
...
void readvl5301(int reg, int lectura){
        ...
        I2C0_MSA_R=(Adrevl5301<<1)&0xFE; //Cargo la dirección del DS1207 e indico "SEND", es decir, el Slave va a recibir
...
void configvl53l0x(void){
    ...
    writevl5301(GLOBAL_CONFIG_REF_EN_START_SELECT, 0xB4); //indice de matriz SPADs
